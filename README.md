...
```bash
git clone https://github.com/marsz197/TrafficSignAiDetector.git
```

2) Frontend: install npm

```bash
cd TrafficSignAiDetector/Frontend/Traffic-sign-recognition
npm install
```
...
python demo.py
```
The link on the terminal should be (http://localhost:5173/)
